...
// This method takes two integers, n and p, as parameters and finds n^p. If either n or p
// is negative, then the method must throw an exception which says "n or p should not be
